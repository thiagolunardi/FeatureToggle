...
using TL.FeatureToggles.Examples;
using TL.FeatureToggles.Examples.InversionOfDecision;
using Xunit;

namespace TL.FeatureToggles.Tests;

[Collection(nameof(FeatureToggleCollection))]
public class InversionOfDecisionTests
{
    private readonly FeatureDecisions _featureDecisions;
    private readonly IToggleRouter _toggleRouter;

    public InversionOfDecisionTests(FeatureToggleFixture fixture)
    {
